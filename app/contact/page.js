export default function Contact() {
  return (
    <section>
      ...
      <div className=''>
        <div className='flex space-x-4 font-bold py-2 hover:text-violet-600'>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 320 512' width='24' height='24' className='fill-current'>
        ...
        <div className='flex space-x-4 font-bold py-2 hover:text-violet-600'>
          ...
          <a href='https://x.com/ImpostorEnginer' target='_blank'>
            @ImpostorEnginer
          </a>
        </div>
        <div className='flex space-x-4 font-bold py-2 hover:text-violet-600'>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 496 512' width={24} height={24} className='fill-current'>
